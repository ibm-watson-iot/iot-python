...
class TestThing(testUtils.AbstractTest):
    ...
    def testCreatePreReqs(self):
        ...
        TestThing.createdDT.mappings.create(
            {
                ...
                "propertyMappings": {TestThing.testEventId: {"temperature": "$event.temperature"}},
            }
        )
        ...
        testThingTypeLISchema = {
            ...
            "description": "defines the properties of a schema type",
            "properties": {"Temperature": {"type": "number", "description": "info", "default": 0.0}},
            "required": ["Temperature"],
        }
        ...
        LItest = TestThing.createdTT.logicalInterfaces.create({"id": TestThing.createdThingLI.id})
