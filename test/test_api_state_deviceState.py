...
class TestDeviceState(testUtils.AbstractTest):
    ...
    def testCreatePreReqs(self):
        ...
        TestDeviceState.createdEventSchema = self.createSchema(
            test_schema_name, 
            "eventSchema.json", 
            TestDeviceState.testEventSchema, 
            "Test schema description")
        ...
        TestDeviceState.createdPI.events.create({"eventId": TestDeviceState.testEventId, "eventTypeId": TestDeviceState.createdEventType.id})
    ...
    def testDeletePreReqs(self):
        ...
        del self.appClient.state.active.deviceTypes[TestDeviceState.createdDT.id].devices[TestDeviceState.createdDevice.deviceId]
