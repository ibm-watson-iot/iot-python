...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-n", "--numberOfDevices", required=True, type=int, help="How many device configuration files should be produced by the factory. Max value is 1000"
    )
    parser.add_argument(
    ...
    if args.typeId not in client.registry.devicetypes:
        client.registry.devicetypes.create({"id": args.typeId, "classId": args.classId, "description": "Created by deviceFactory"})
