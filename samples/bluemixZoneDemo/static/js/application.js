...
//
//	/*
//	 * Create the MQTT client that will subscribe to events from a specific device
//	 */
...
//
//	/*
//	 * Create a handler to deal with incoming events from a device
//	 */
...
//	
//	/*
//	 * Create a handler to detect dropped connections - reconnecting after a second. We include this short delay to help
//	 * prevent a chronic misconfiguration leading to rapid connect attempts on your organization.
//	 */
//	client.onConnectionLost = function onConnectionLost(){
//		console.log("Connection lost!");
//        setTimeout(connectApp(deviceId), 1000);	
//	};
//
//	/*
//	 * If we connect successfully, then subscribe to the specific device's topic. We perform this at each connect success, as we are using
//	 * QoS0/cleanSession=true in this simple demo. 
//	 */
...
//
//	/*
//	 * If our connect attempt fails, then let's try again. We include a short delay to ensure that a chronic misconfiguration
//	 * does not lead to rapid connect attempts on your organization.
//	 */
...
//	
//	/*
//	 * Connect the application to the IoT Foundation, and subscribe to events from a specific device
//	 */
//    function connectApp(deviceId){
