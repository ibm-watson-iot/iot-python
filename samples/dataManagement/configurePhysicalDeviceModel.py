...
def manageEventType(typeName, schemaId, description):
    ...
    if existingType is None:
        ...
        createdType = client.state.draft.eventTypes.create({"name": typeName, "description": description, "schemaId": schemaId})
        print(createdType)
        print("")
        return createdType
    else:
...
if __name__ == "__main__":
    ...
    # Create Event Type
    # =========================================================================
    psutilEventType = manageEventType(typeName="psutil-etype", description="PSUTIL Event Type", schemaId=psutilSchema.id)
    ...
    # =========================================================================
    psutilPi = managePI(piName="psutil-pi", description="PSUTIL Physical Interface", eventId="psutil", eventTypeId=psutilEventType.id)
    oshiPi = managePI(piName="oshi-pi", description="OSHI Physical Interface", eventId="oshi", eventTypeId=oshiEventType.id)
    ...
    print("")
    print("")
    print("Congratulations.  You have now configured the physical device model for the IoT PSUTIL and IoT OSHI reference device samples")
