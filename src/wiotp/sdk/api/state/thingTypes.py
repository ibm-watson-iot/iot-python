...
class ActiveThingType(BaseThingType):
    def __init__(self, apiClient, **kwargs):
        ...
        self._logicalInterfaces = ActiveLogicalInterfaces(apiClient, self.id) # TBD need to provide access to active and draft.
...
class DraftIterableThingTypeList(IterableList):
    def __init__(self, apiClient, url, filters=None):
        ...
        super(DraftIterableThingTypeList, self).__init__(
            apiClient, DraftThingType, url, filters=filters
        )
        
class ActiveIterableThingTypeList(IterableList):
    def __init__(self, apiClient, url, filters=None):
        # This API does not support sorting
        super(ActiveIterableThingTypeList, self).__init__(
            apiClient, ActiveThingType, url, filters=filters
        )
...
class IterableMappingList(IterableSimpleList):
    def __init__(self, apiClient, url, filters=None, passApiClient=False):
        ...
        super(IterableMappingList, self).__init__(
            apiClient, ThingTypeMapping, url
        )
